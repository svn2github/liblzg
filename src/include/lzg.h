...
#define LZG_VERSION "1.0.1"    /**< @brief LZG library version string */
#define LZG_VERNUM  0x01000001 /**< @brief LZG library version number (strictly
                                    incremental) */
#define LZG_VER_MAJOR    1     /**< @brief LZG library major version */
#define LZG_VER_MINOR    0     /**< @brief LZG library minor version */
#define LZG_VER_REVISION 1     /**< @brief LZG library revision */
